...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 21, 2026 at 03:49 PM
...
(2, 'EMP003', 2, '2026-03-20', '2026-06-30', 1, '2026-03-20 04:03:56', '2026-03-20 04:03:56');
...
--
-- Dumping data for table `wfa_risk_assessment`
--

INSERT INTO `wfa_risk_assessment` (`id`, `employee_id`, `risk_level`, `risk_score`, `risk_factors`, `low_performance_flag`, `high_absence_flag`, `low_engagement_flag`, `recent_complaints_flag`, `performance_score`, `absence_days`, `tenure_months`, `last_assessment_date`, `notes`, `created_at`, `updated_at`) VALUES
(1, 'EMP001', 'low', 25.50, '[\"none\"]', 0, 0, 0, 0, 4.50, 2, 36, NULL, NULL, '2026-03-21 09:23:29', '2026-03-21 09:23:29'),
(2, 'EMP002', 'medium', 55.75, '[\"high_absence\", \"low_engagement\"]', 0, 1, 0, 0, 3.50, 18, 24, NULL, NULL, '2026-03-21 09:23:29', '2026-03-21 09:23:29'),
(3, 'EMP003', 'high', 78.25, '[\"low_performance\", \"high_absence\", \"tenure\"]', 1, 1, 0, 0, 2.50, 20, 6, NULL, NULL, '2026-03-21 09:23:29', '2026-03-21 09:23:29');
...
--
ALTER TABLE `ta_employee_shifts`
  MODIFY `employee_shift_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `ta_absence_late_records`
  ADD CONSTRAINT `ta_absence_late_records_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;

--
-- Constraints for table `ta_absence_late_thresholds`
--
ALTER TABLE `ta_absence_late_thresholds`
  ADD CONSTRAINT `ta_absence_late_thresholds_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
...
--
-- Constraints for table `ta_attendance_metrics`
--
ALTER TABLE `ta_attendance_metrics`
  ADD CONSTRAINT `ta_attendance_metrics_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
...
--
-- Constraints for table `ta_overtime_frequency`
--
ALTER TABLE `ta_overtime_frequency`
  ADD CONSTRAINT `ta_overtime_frequency_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;

--
-- Constraints for table `ta_overtime_tracking`
--
ALTER TABLE `ta_overtime_tracking`
  ADD CONSTRAINT `ta_overtime_tracking_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;

--
-- Constraints for table `ta_punctuality_scores`
--
ALTER TABLE `ta_punctuality_scores`
  ADD CONSTRAINT `ta_punctuality_scores_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;

--
-- Constraints for table `wfa_attrition_tracking`
--
ALTER TABLE `wfa_attrition_tracking`
  ADD CONSTRAINT `wfa_attrition_tracking_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;

--
-- Constraints for table `wfa_risk_assessment`
--
ALTER TABLE `wfa_risk_assessment`
  ADD CONSTRAINT `wfa_risk_assessment_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
COMMIT;
