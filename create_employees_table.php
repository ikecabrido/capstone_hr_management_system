...
try {
    ...
    echo "Creating new employees table...\n";
    ...
    echo "Step 2: Adding indexes and constraints...\n";
    ...
    // Step 3: Insert new data from SQL file
    ...
    echo "Step 4: Verifying creation...\n";
    ...
    // Show sample data
    echo "\nSample records:\n";
    $sampleStmt = $db->query('SELECT employee_id, full_name, department, position FROM employees LIMIT 5');
    while ($row = $sampleStmt->fetch(PDO::FETCH_ASSOC)) {
        echo "- " . $row['full_name'] . " (" . $row['department'] . " - " . $row['position'] . ")\n";
    }
