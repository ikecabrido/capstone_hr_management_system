...
<head>
  ...
  <title>Recruitment and Onboarding Management</title>
...
<body
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-dark">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="recruitment.php" class="nav-link">Home</a>
        </li>
      </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="recruitment.php" class="brand-link">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Recruitment and Onboarding Management System</h1>
            </div>
            <!-- /.col -->
