...
// Performance-based Recognition & Rewards Integration
$payload['recognition_recommendations'] = $recognitionCtrl->getRecognitionRecommendations(10);
$payload['performance_leaderboard'] = $recognitionCtrl->getPerformanceLeaderboard(20);
...
<body
  ...
  <script> fetch('api/index.php?resource=communication&action=notifications')
        .then(r => r.json())
        .then(data => {
          ...
          data.forEach(notification => {
            ...
            title.textContent = notification.title || notification.message || 'Notification';
