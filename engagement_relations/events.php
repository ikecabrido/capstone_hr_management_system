...
// Event data is loaded from API endpoints via JS
$events = [];
$registeredEvents = [];
?>
<!doctype html>
      ...
      <div class="content-header">
        <div class="container-fluid">
          ...
          <!-- /.row -->
                ...
                <div id="content">
                    <div id="events-container" style="min-height: 160px; padding: 20px; color: #666;">Loading events...</div>
                </div>
      </div>
    </div>
...
<script data-user-id="<?= htmlspecialchars($user['employee_id'] ?? $user['id'] ?? 'null') ?>" src="js/main.js?v=<?= time(); ?>"></script>
<script src="js/events.js?v=<?= time(); ?>"></script>
</body>
</html>
