...
class Project extends BaseModel
{
    ...
    public function createProject($name, $description, $deadline, $status, $createdBy)
    {
        ...
        $sql = 'INSERT INTO eer_projects (name, description, deadline, status, created_by_user_id, created_at)
                VALUES (:name, :description, :deadline, :status, :created_by_user_id, NOW())';
