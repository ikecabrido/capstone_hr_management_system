...
<head>
    ...
    <link rel="stylesheet" href="css/engagement-modules.css" />
</head>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            ...
                            <p>Please fill out the survey questions below and submit your responses.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="mt-4">
                ...
                <?php foreach ($surveyResponses as $response): ?>
                    <div class="response-item">
                        <p><strong>Response ID:</strong> <?= isset($response['eer_survey_response_id']) ? htmlspecialchars($response['eer_survey_response_id']) : 'N/A' ?></p>
