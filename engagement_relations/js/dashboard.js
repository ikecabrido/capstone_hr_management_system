...
function renderDashboard(dashboard, role) {
    ...
    // Default dashboard for engagement_relations role
        ...
        html += `
            ...
            <div class="metrics-grid">
                <div class="metric-card"><div class="metric-label">Pending Grievances</div><div class="metric-value">${(dashboard.critical_metrics?.pending_grievances) || 0}</div></div>
                <div class="metric-card"><div class="metric-label">Open Grievances</div><div class="metric-value">${(dashboard.critical_metrics?.open_grievances) || 0}</div></div>
                <div class="metric-card"><div class="metric-label">Under Investigation</div><div class="metric-value">${(dashboard.critical_metrics?.under_investigation) || 0}</div></div>
                <div class="metric-card"><div class="metric-label">Pending Feedback</div><div class="metric-value">${(dashboard.critical_metrics?.pending_feedback) || 0}</div></div>
            </div>
        `;
    ...
    // Critical metrics for all dashboards
