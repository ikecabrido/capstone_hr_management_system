...
// announcements will be loaded via JS from api/announcements_data.php        
...
<body
  ...
  <script></script>
<script data-token="<?= htmlspecialchars($token ?? '') ?>" data-user-id="<?= $user['id'] ?? 'null' ?>" src="js/main.js?v=<?= time(); ?>"></script>
