...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2026 at 04:30 PM
...
(1, NULL, 1, 'safety', 'medium', NULL, 'minor', 'Minor Workplace Accident', 'Minor workplace accident reported - first aid administered', '2026-03-01', NULL, NULL, NULL, NULL, NULL, 'Employee', 0, 0, '', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '2026-03-17 09:08:07', '2026-03-17 09:08:07'),
(2, NULL, 3, 'harassment', 'medium', NULL, 'minor', 'Verbal Harassment Incident', 'Reported verbal harassment incident in the workplace', '2026-03-10', NULL, NULL, NULL, NULL, NULL, 'Employee', 0, 0, '', 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '2026-03-17 09:08:07', '2026-03-17 09:08:07'),
(3, NULL, 2, 'policy', 'medium', NULL, 'minor', 'Policy Violation', 'Policy violation incident - resolved with counseling', '2026-02-15', NULL, NULL, NULL, NULL, NULL, 'Employee', 0, 0, 'resolved', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '2026-03-17 09:08:07', '2026-03-17 09:08:07'),
(4, NULL, 2, 'complaint', 'medium', NULL, 'minor', 'dsdad', 'ddd', '2026-03-18', NULL, 'ddd', NULL, NULL, NULL, 'Employee', 1, 0, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, '2026-03-18 07:38:12', '2026-03-18 07:38:12');
...
(13, 'Benefits and Compensation Policy', 6, 'Finance', '1.0', 'Defines salary structure, allowances, and government-mandated benefits.', 'Pending Approval', 18, 18, NULL, '2026-02-01', NULL, '2026-02-08 04:00:00', NULL, '2026-03-18 08:24:37', '2026-03-18 11:54:54', 1, 1);
...
--
ALTER TABLE `leave_approvals`
  ADD CONSTRAINT `leave_approvals_ibfk_1` FOREIGN KEY (`leave_application_id`) REFERENCES `leave_applications` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `leave_attachments`
--
ALTER TABLE `leave_attachments`
  ADD CONSTRAINT `leave_attachments_ibfk_1` FOREIGN KEY (`leave_application_id`) REFERENCES `leave_applications` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `leave_history`
  ...
  ADD CONSTRAINT `leave_history_ibfk_3` FOREIGN KEY (`leave_application_id`) REFERENCES `leave_applications` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `leave_notifications`
  ...
  ADD CONSTRAINT `leave_notifications_ibfk_2` FOREIGN KEY (`leave_application_id`) REFERENCES `leave_applications` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `leave_payroll_integrations`
--
ALTER TABLE `leave_payroll_integrations`
  ADD CONSTRAINT `leave_payroll_integrations_ibfk_1` FOREIGN KEY (`leave_application_id`) REFERENCES `leave_applications` (`id`) ON DELETE CASCADE,
