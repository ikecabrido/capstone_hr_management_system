<div class="container-fluid py-4">
    ...
    <div class="main-content">
        <div class="content-wrapper">
            ...
            <?php if (!empty($_SESSION['show_time_in_confirm'])): ?>
                <?php unset($_SESSION['show_time_in_confirm']); ?>
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        if (typeof showTimeInConfirmation === 'function') {
            ...
            <?php if (!empty($_SESSION['show_time_out_confirm'])): ?>
                <?php unset($_SESSION['show_time_out_confirm']); ?>
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        if (typeof showTimeOutConfirmation === 'function') {
