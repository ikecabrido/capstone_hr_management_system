...
// Determine the correct path to incident (disciplinary) based on current location
function getIncidentPath($currentFolder) {
    if ($currentFolder === 'leave_management' || $currentFolder === 'employee_management' || $currentFolder === 'payroll') {
        return '../legal_compliance/incident.php';
    } elseif ($currentFolder === 'views') {
        return '../incident.php';
    } else {
        return 'incident.php';
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= getIncidentPath($currentFolder) ?>" class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'incident.php' ? 'active' : '' ?>">
