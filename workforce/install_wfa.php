...
if ($all_passed) {
    ...
    echo "<li>Read guide: <a href='WFA_INTEGRATION_GUIDE.md' target='_blank'>Integration Guide</a></li>";
    echo "<li>Quick start: <a href='QUICK_START_WFA.md' target='_blank'>Quick Start</a></li>";
    echo "</ul>";
} else {
