...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed <?= $theme === 'dark' ? 'dark-mode' : '' ?>">
  <div class="wrapper">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item"><a href="training_requests.php" class="nav-link"><i class="nav-icon fas fa-clipboard-list"></i><p>Training Requests</p></a></li>
            <?php endif; ?>
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="manage-card" data-search="<?= strtolower(htmlspecialchars($program['title'] . ' ' . $program['trainer'] . ' ' . $program['description'])) ?>">
                      ...
                      <div class="manage-card-body">
                        ...
                        <div class="manage-card-info"><div class="manage-card-info-item"><div class="manage-card-info-label">Trainer</div><div class="manage-card-info-value"><?= htmlspecialchars($program['trainer'] ?? 'N/A') ?></div></div><div class="manage-card-info-item"><div class="manage-card-info-label">Participants</div><div class="manage-card-info-value"><?= $program['max_participants'] ?></div></div><div class="manage-card-info-item"><div class="manage-card-info-label">Test/Quiz</div><div class="manage-card-info-value">1 Test</div></div></div>
                        <div class="manage-card-actions">
                          <button class="btn btn-primary btn-sm" onclick="openGlobalModal('Program Details', 'manage_learning_modal.php?type=program&view_id=<?= $program['ld_training_programs_id'] ?>')"><i class="fas fa-eye"></i> View</button>
                  ...
                  <div class="col-lg-4 col-md-6 mb-4">
                    <div class="manage-card" data-search="<?= strtolower(htmlspecialchars($course['title'] . ' ' . $course['instructor'] . ' ' . $course['description'])) ?>">
                      ...
                      <div class="manage-card-body">
                        ...
                        <div class="manage-card-info"><div class="manage-card-info-item"><div class="manage-card-info-label">Instructor</div><div class="manage-card-info-value"><?= htmlspecialchars($course['instructor'] ?? 'N/A') ?></div></div><div class="manage-card-info-item"><div class="manage-card-info-label">Duration</div><div class="manage-card-info-value"><?= $course['duration_hours'] ?>h</div></div><div class="manage-card-info-item"><div class="manage-card-info-label">Test/Quiz</div><div class="manage-card-info-value">1 Quiz</div></div></div>
                        <div class="manage-card-actions">
                          <button class="btn btn-primary btn-sm" onclick="openGlobalModal('Course Details', 'manage_learning_modal.php?type=course&view_id=<?= $course['ld_courses_id'] ?>')"><i class="fas fa-eye"></i> View</button>
    ...
    <?php if (in_array($_SESSION['user']['role'], ['learning', 'admin'])): ?>
  ...
  <script>
    function enrollProgram(id) {
      ...
      // Disable all enrollment buttons to prevent double-clicking
      const buttons = document.querySelectorAll('button[onclick*="enrollProgram"], button[onclick*="enrollCourse"]');
    ...
    function openCreateModal() {
      ...
      const type = section === 'courses' ? 'course' : 'program';
      const title = section === 'courses' ? 'Create Course' : 'Create Training Program';
      openGlobalModal(title, 'manage_learning_modal.php?type=' + type);
    }
