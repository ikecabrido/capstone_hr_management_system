...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed <?= $theme === 'dark' ? 'dark-mode' : '' ?>">
  ...
  <script>
    ...
    function editProgram(id) {
      openGlobalModal('Edit Training Program', 'manage_learning_modal.php?type=program&edit_id=' + id);
    }
    ...
    function editCourse(id) {
      openGlobalModal('Edit Course', 'manage_learning_modal.php?type=course&edit_id=' + id);
    }
